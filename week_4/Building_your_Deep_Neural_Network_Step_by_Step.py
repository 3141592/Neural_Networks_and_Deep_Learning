...
def update_parameters(params, grads, learning_rate):
    ...
    for l in range(L):
        ...
        # YOUR CODE STARTS HERE
        parameters["W" + str(l+1)] = parameters["W" + str(l+1)] - learning_rate * copy.deepcopy(grads["dW" + str(l+1)])
        parameters["b" + str(l+1)] = parameters["b" + str(l+1)] - learning_rate * copy.deepcopy(grads["db" + str(l+1)])
        # YOUR CODE ENDS HERE
    return parameters
